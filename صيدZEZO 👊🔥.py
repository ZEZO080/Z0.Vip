...
ugen=[]
for moad in range(5): 
    a='Mozilla/5.0 (Linux; Android 9.1.0; C5 2012 Build/OPM2.281039.022) AppleWebKit/637.36 (KHTML, like Gecko) Chrome/122.0.6261.64 Mobile Safari/537.36'
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mzezo-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mzezo-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mzezo-2F.txt' %
              (H, P, str(len(twf))))
